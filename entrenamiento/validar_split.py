...
file0 = open('flujo_base_tenders-id.txt')
file1 = open('flujo_experimental_1_tenders-id.txt')
file2 = open('flujo_experimental_2_tenders-id.txt')
file3 = open('flujo_experimental_3_tenders-id.txt')
file4 = open('flujo_experimental_4_tenders-id.txt')
file5 = open('flujo_experimental_5_tenders-id.txt')
file6 = open('flujo_experimental_6_tenders-id.txt')
file7 = open('flujo_experimental_7_tenders-id.txt')
file8 = open('flujo_experimental_8_tenders-id.txt')
file9 = open('flujo_experimental_9_tenders-id.txt')
file10 = open('flujo_experimental_10_tenders-id.txt')
